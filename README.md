...
GitHub does have your back here though. If you accidentally push code to a repository that contains a valid access token, GitHub will revoke that token. Thanks GitHub ð
...
## Addition of normalize-url package ð
...
## Fix broken links in gravatar ð
...
## Redux subscription to manage local storage ð¥
...
## Log user out on token expiration ð
...
After running a build in the client ð, cd into the root of the project.  
And run...
